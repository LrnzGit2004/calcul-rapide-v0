...
export default function GeometryLevelSelect() {
  ...
  const startGame = () => {
    ...
    const url = `/game?grade=${encodeURIComponent(String(grade))}&module=geo&difficulty=${selectedDifficulty}`;
